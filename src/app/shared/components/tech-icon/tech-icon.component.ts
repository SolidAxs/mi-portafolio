      ...
      @switch (iconKey()) {
        ...
        @case ('java 8 / java 17') {
          <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 4.5c.8 1.2.3 2.1-.2 2.7-.4.6-.6 1-.3 1.6.4.8 1.5 1.1 2.3.8-.5.8-1.5 1.1-2.2.9-1.2-.4-1.8-1.6-1.3-2.6.4-.8.9-1.5.3-2.2-.4-.6-1.1-.9-1.5-1.2 1 .3 2.1.8 2.9 1.7zm-2.8 3c.6.9.2 1.6-.2 2.1-.3.5-.5.8-.2 1.3.3.6 1.2.9 1.8.6-.4.6-1.2.9-1.8.7-.9-.3-1.4-1.3-1-2.1.3-.6.7-1.2.2-1.7-.3-.5-.9-.7-1.2-.9.8.2 1.7.6 2.4 1.4zM7 16.5c3.5 1.2 7.5 1.2 10 0 .5-.2.8-.7.2-1.1-2.5-.8-6.5-.8-9 0-.6.4-.3.9.8 1.1zm.5 2.2c3 1 6 1 8.5 0 .4-.2.6-.5.1-.8-2-.6-5.5-.6-7.5 0-.5.3-.3.6.9.8zm-1.8-4.2c4 1.5 9 1.5 12.5 0 .6-.2.9-.8.2-1.3-3.2-1-8.5-1-11.5 0-.7.5-.4 1.1 1.2 1.3z" fill="#FFFFFF"/>
          </svg>
        }
        @case ('spring boot')
        @case ('spring') {
          <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 4a8 8 0 00-8 8c0 4.4 3.6 8 8 8s8-3.6 8-8a8 8 0 00-8-8zm-2.5 12.5a4.5 4.5 0 01-1.3-3.2c0-2.5 2-4.5 4.5-4.5 1.2 0 2.3.5 3.1 1.3l-1.4 1.4c-.4-.4-1-.7-1.7-.7-1.4 0-2.5 1.1-2.5 2.5 0 .7.3 1.3.7 1.7l-1.4 1.5z" fill="#FFFFFF"/>
          </svg>
        }
        @case ('spring data') {
          <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none">
            <rect width="24" height="24" rx="5" fill="#6DB33F"/>
            <path d="M12 4c-4 0-7 1.2-7 2.5v11c0 1.3 3 2.5 7 2.5s7-1.2 7-2.5v-11C19 5.2 16 4 12 4zm0 2c3.2 0 5.2.9 5.2 1.2S15.2 8.4 12 8.4 6.8 7.5 6.8 7.2 8.8 6 12 6zm-5.2 4.2c1.3.6 3.2.9 5.2.9s3.9-.3 5.2-.9v2.1c-1.3.6-3.2.9-5.2.9s-3.9-.3-5.2-.9v-2.1zm0 4.5c1.3.6 3.2.9 5.2.9s3.9-.3 5.2-.9v2.1c-1.3.6-3.2.9-5.2.9s-3.9-.3-5.2-.9v-2.1z" fill="#FFFFFF"/>
          </svg>
        }
        @case ('spring security') {
          <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none">
            <rect width="24" height="24" rx="5" fill="#6DB33F"/>
            <path d="M12 4L5 7v5c0 4.5 3 8.5 7 10 4-1.5 7-5.5 7-10V7l-7-3zm0 3.2c1.5 0 2.8 1.2 2.8 2.8 0 .8-.4 1.6-1 2.1v2.9h-3.5V12.1c-.6-.5-1-1.3-1-2.1 0-1.6 1.3-2.8 2.7-2.8z" fill="#FFFFFF"/>
          </svg>
        }
        @case ('fastapi') {
          <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" fill="none">
