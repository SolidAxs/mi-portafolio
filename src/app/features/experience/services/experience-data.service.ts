...
const EXPERIENCES_DATA: ExperienceItem[] = [
  // ── 1. Trinum Solutions (Última Experiencia) ──────────────────────────────
  {
    ...
    highlights: [
      ...
      'Desarrollo de Servicios e Integraciones (.NET): Diseñé y desplegué servicios en .NET Framework críticos para la operación, incluyendo la sincronización masiva de timezones en servidores locales, la recolección automatizada de logs para proveedores y la extracción de datos centralizados para reportes ejecutivos.',
